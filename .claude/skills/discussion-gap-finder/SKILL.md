...
description: Analyzes GitHub discussion links to identify documentation gaps. Fetches the discussion, reviews questions and answers, searches existing docs for coverage, and recommends next steps (create new content, adjust existing content, or no action needed). Invoke with /discussion-gap-finder.
user-invocable: true
---
