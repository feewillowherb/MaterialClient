...
public static class ReaderWriterLockSlimExtensions
{
    ...
    public readonly struct WriteLockDisposable : IDisposable
    {
        ...
        internal WriteLockDisposable(ReaderWriterLockSlim rwLock) => _rwLock = rwLock;
    ...
    public readonly struct UpgradeableReadLockDisposable : IDisposable
    {
        ...
        internal UpgradeableReadLockDisposable(ReaderWriterLockSlim rwLock) => _rwLock = rwLock;
