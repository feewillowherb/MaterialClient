...
#define SourceDir "{src}\..\..\..\src\MaterialClient.Urban\bin\Release\net10.0\win-x64\publish"
#define IconFile "{src}\..\..\..\src\MaterialClient.Urban\Assets\fd-ico.ico"
...
Source: "{#SourceDir}\appsettings.secret.json"; DestDir: "{app}"; Flags: ignoreversion
